...
describe('Report Frequency Service', () => {
  ...
  it('Should not let do a request if no accessToken is provided', (done) => {
    ...
    app.service('reports/frequency-average-per-day').find(params)
      .catch((err) => {
  ...
  it('Should let do a request if valid accessToken is provided', (done) => {
    ...
    sandbox.stub(app.service('reports/frequency-average-per-day'), 'find')
