...
class CustomTableBody extends React.Component<CustomTableBodyProps> {
  ...
  renderEmpty(emptyRowCount, renderData) {
    ...
    const localization = { ...CustomTableBody.defaultProps.localization, ...this.props.localization };
      ...
      if (data.tableData.editing) {
        return (
          <this.props.components.EditRow
            ...
            localization={{ ...CustomTableBody.defaultProps.localization.editRow, ...this.props.localization.editRow }}
            key={index}
    ...
    return (
      <TableBody>
        ...
        <this.props.components.FilterRow
          ...
          localization={{ ...CustomTableBody.defaultProps.localization.filterRow, ...this.props.localization.filterRow }}
        ...
        {this.props.showAddRow && !this.props.parentId && this.props.options.addRowPosition === 'first' &&
        <this.props.components.EditRow
          columns={this.props.columns.filter(columnDef => { return !columnDef.hidden; })}
          data={this.props.initialFormData}
          components={this.props.components}
        ...
        {this.props.showAddRow && !this.props.parentId && this.props.options.addRowPosition === 'last' &&
        <this.props.components.EditRow
          columns={this.props.columns.filter(columnDef => { return !columnDef.hidden; })}
          data={this.props.initialFormData}
          components={this.props.components}
