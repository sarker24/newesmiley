...
type PreviousPeriodsOverrideDialogProps = InjectedIntlProps & OwnProps;

const PreviousPeriodsOverrideDialog: React.FunctionComponent<PreviousPeriodsOverrideDialogProps> = (
  props
) => {
...
export default injectIntl(PreviousPeriodsOverrideDialog);
